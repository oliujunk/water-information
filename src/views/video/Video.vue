<template>
  <div class="performance">
    ...
    >
      ...
      <vxe-table-column field="unit" title="视频地址"></vxe-table-column>
      <vxe-table-column field="year" title="端口号"></vxe-table-column>
      <vxe-table-column field="type" title="视频通道号"></vxe-table-column>
      <vxe-table-column field="indicator" title="登录名"></vxe-table-column>
      <vxe-table-column field="score" title="密码"></vxe-table-column>
