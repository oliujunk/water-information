<template>
  <div>
    ...
    >
      ...
      <vxe-table-column field="stationType" title="测点类型"></vxe-table-column>
      <vxe-table-column field="stationNumber" title="测点数"></vxe-table-column>
      <vxe-table-column field="rightNumber" title="正常运行个数"></vxe-table-column>
      <vxe-table-column field="yearDataNumber" title="年上报数据量"></vxe-table-column>
...
export default {
  data() {
    return {
      ...
      tableData: [
        {
          unit: '单位1', stationType: '气象站', stationNumber: 5, rightNumber: 5, yearDataNumber: 50000,
        },
        {
          unit: '单位1', stationType: '气象站', stationNumber: 5, rightNumber: 5, yearDataNumber: 50000,
        },
