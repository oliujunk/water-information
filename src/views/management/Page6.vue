<template>
  <div>
    ...
    >
      ...
      <vxe-table-column field="prop2" title="供水单位"></vxe-table-column>
      <vxe-table-column field="prop3" title="用水单位"></vxe-table-column>
      <vxe-table-column field="prop4" title="水费收缴"></vxe-table-column>
