<template>
  <div>
    ...
    >
      ...
      <vxe-table-column field="prop2" title="完善农田水利工程体系"></vxe-table-column>
      <vxe-table-column field="prop3" title="工程维修"></vxe-table-column>
      <vxe-table-column field="prop4" title="供水计划"></vxe-table-column>
      <vxe-table-column field="prop5" title="供水调度"></vxe-table-column>
      <vxe-table-column field="prop6" title="成本控制"></vxe-table-column>
