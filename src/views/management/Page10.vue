<template>
  <div>
    ...
    >
      ...
      <vxe-table-column field="prop2" title="补贴对象"></vxe-table-column>
      <vxe-table-column field="prop3" title="补贴方式"></vxe-table-column>
      <vxe-table-column field="prop4" title="补贴环节"></vxe-table-column>
      <vxe-table-column field="prop5" title="补贴标准"></vxe-table-column>
      <vxe-table-column field="prop6" title="资金使用管理"></vxe-table-column>
