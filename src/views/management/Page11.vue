<template>
  <div>
    ...
    >
      ...
      <vxe-table-colgroup title="奖励对象">
        <vxe-table-column field="prop2" title="规模经营主体"></vxe-table-column>
        <vxe-table-column field="prop3" title="农民用水合作组织"></vxe-table-column>
        <vxe-table-column field="prop4" title="用水户"></vxe-table-column>
      </vxe-table-colgroup>
      <vxe-table-column field="prop5" title="奖励机制"></vxe-table-column>
