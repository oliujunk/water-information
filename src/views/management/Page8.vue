<template>
  <div>
    ...
    >
      ...
      <vxe-table-column field="prop2" title="粮食作物"></vxe-table-column>
      <vxe-table-column field="prop3" title="经济作物"></vxe-table-column>
      <vxe-table-column field="prop4" title="养殖"></vxe-table-column>
      <vxe-table-column field="prop5" title="地表水"></vxe-table-column>
      <vxe-table-column field="prop6" title="地下水"></vxe-table-column>
