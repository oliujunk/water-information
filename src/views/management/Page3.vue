<template>
  <div>
    ...
    >
      ...
      <vxe-table-column field="prop2" title="用水总量指标"></vxe-table-column>
      <vxe-table-column field="prop3" title="灌溉用水定额"></vxe-table-column>
      <vxe-table-column field="prop4" title="农业水权交易"></vxe-table-column>
