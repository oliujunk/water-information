<template>
  <div>
    ...
    >
      ...
      <vxe-table-column field="unit" title="上报时间"></vxe-table-column>
      <vxe-table-column field="areaName" title="水位"></vxe-table-column>
      <vxe-table-column field="areaType" title="流量"></vxe-table-column>
      <vxe-table-column field="deviceName" title="水量"></vxe-table-column>
      <vxe-table-column field="projectType" title="拟合类型"></vxe-table-column>
