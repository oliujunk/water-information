<template>
  <div>
    ...
    >
      ...
      <vxe-table-column field="unit" title="站点名称"></vxe-table-column>
      <vxe-table-column field="areaName" title="灌区名称"></vxe-table-column>
      <vxe-table-column field="areaType" title="灌区类型"></vxe-table-column>
      <vxe-table-column field="deviceName" title="数值"></vxe-table-column>
      <vxe-table-column field="projectType" title="时间"></vxe-table-column>
